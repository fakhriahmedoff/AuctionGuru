                                            ...
                                            <li class="dropdown no-line-effect">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="#" class="dropdown-item"><img
                                                                src="{{asset('frontend')}}/images/img-blank.gif" class="flag flag-us" alt="English">
                                                            English</a></li>
                                                    <li><a href="#" class="dropdown-item"><img
                                                                src="{{asset('frontend')}}/images/img-blank.gif" class="flag flag-es"
                                                                alt="Espa&ntilde;ol"> Espa&ntilde;ol</a></li>
                                                    <li><a href="#" class="dropdown-item"><img
                                                                src="{{asset('frontend')}}/images/img-blank.gif" class="flag flag-fr"
