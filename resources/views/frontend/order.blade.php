                    ...
                    <div class="col-lg-7 mb-4 mb-lg-0">
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <textarea class="form-control h-auto py-2" name="message" rows="5"
                                          placeholder="Notes about you orderm e.g. special notes for delivery"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class="form-label">Attach your auction sheet <span class="text-color-danger">*</span></label>
                                <input type="file" class="form-control h-auto py-2" name="uploaded_files[]" multiple value=""
                                       required="">
                            </div>
                        </div>
                    </div>
