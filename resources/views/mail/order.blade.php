...
<html>
<head>
    <title>Auction Guru Payment </title>
</head>
...
<table width="600" height="auto" align="center" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td width="600" height="auto" bgcolor="#000" border="0"
            ...
            <h1 style="color:#ffffff; font-family:&quot; Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif; font-size:30px; line-height:150%; font-weight:300; margin:0; text-align:left;">
    ...
    <tr>
        <td width="600" bgcolor="#fdfdfd" border="0"
            ...
            <p style="margin:0 0 16px;">
                <b>Customer name: {{$model->name}}</b>
            </p>
            <p style="margin:0 0 16px;">
                <b>Customer email: {{$model->email}}</b>
            </p>
            <p style="margin:0 0 16px;">
                <b>Payment type: {{__('site.'.$model->payment_method)}}</b>
            </p>
            <p style="margin:0 0 16px;">
                <b>Package: {{$model->plan->name}} | Price: {{$model->plan->price}}$</b>
            </p>

            <p>
                Thank you for choosing Auction Guru for your auction sheet translation
            </p>
    ...
    <tr>
        <td width="600" border="0"
            ...
            <p><a href="{{\Illuminate\Support\Facades\URL::route('home')}}">Auction Guru</a></p>
        </td>
    </tr>
</table>
</body>
